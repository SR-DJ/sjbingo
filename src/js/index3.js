const gridEl = document.getElementById('grid');
      ...
      // 组A: path1/1 = path2/1 = inner/1
            'images3/path1/1.jpg': 'content_A',
            'images3/path2/1.jpg': 'content_A',
            'images3/inner/23.jpg': 'content_A',
            
            // 组B: path1/2 = inner/8
            'images3/path1/2.jpg': 'content_B',
            'images3/inner/20.jpg': 'content_B',
            
            // 组C: path1/3 = inner/3
            'images3/path1/3.jpg': 'content_C',
            'images3/inner/21.jpg': 'content_C',
            
            // 组D: path1/4 = inner/26
            'images3/path1/4.jpg': 'content_D',
            'images3/inner/25.jpg': 'content_D',
            
            // 组E: path1/5 = inner/27
            'images3/path1/5.jpg': 'content_E',
            'images3/inner/26.jpg': 'content_E',
            
            // 组F: path1/6 = inner/6
            // 'images3/path1/6.jpg': 'content_F',
            // 'images3/inner/6.jpg': 'content_F',
            
            // 组G: path1/7 = path2/7 =inner/19
            'images3/path1/7.jpg': 'content_G',
            'images3/path2/7.jpg': 'content_G',
            'images3/inner/19.jpg': 'content_G',

            // 组H: path2/2 = inner/2 
            'images3/path2/2.jpg': 'content_H',
            'images3/inner/3.jpg': 'content_H',
        
            // 组I: path2/3 = inner/24
            'images3/path2/3.jpg': 'content_I',
            'images3/inner/7.jpg': 'content_I',
            
            // 组J: path2/4 = inner/4
            'images3/path2/4.jpg': 'content_J',
            'images3/inner/5.jpg': 'content_J',
            
            // 组K: path2/5 = inner/5
            'images3/path2/5.jpg': 'content_K',
            'images3/inner/1.jpg': 'content_K',

            // 组L: path2/6 = inner/20
            'images3/path2/6.jpg': 'content_L',
            'images3/inner/27.jpg': 'content_L',

            // 组M: path2/6 = inner/20
            'images3/path1/6.jpg': 'content_M',
            'images3/inner/14.jpg': 'content_M'
        };
        ...
        const maxUsageLimits = {
            ...
            'images3/inner/1.jpg': 1,
            'images3/inner/2.jpg': 2,
            'content_A': 3,  // inner/1 对应的 contentKey
            'content_H': 3,  // inner/2 对应的 contentKey
            
            // inner/3,4,5,6,7,23,25,26 最多使用2次
            'images3/inner/3.jpg': 2,
            'images3/inner/4.jpg': 2,
            'images3/inner/5.jpg': 2,
            'images3/inner/6.jpg': 2,
            'images3/inner/7.jpg': 1,
            'images3/inner/23.jpg': 2,
            'images3/inner/25.jpg': 1,
            'images3/inner/26.jpg': 2,
